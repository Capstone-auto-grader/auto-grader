...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { assignment_tests: @assignment.assignment_tests, due_date: @assignment.due_date } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { assignment_tests: @assignment.assignment_tests, due_date: @assignment.due_date } }
