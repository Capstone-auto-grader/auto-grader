class AssignmentsController < ApplicationController
  ...
  private
    ...
    def assignment_params
      params.require(:assignment).permit(:name, :course_id, :assignment_test, :extra_credit, :test_uri, :base_uri, :test_grade_weight, :submitted_once, :has_resubmission, :has_tests, :container_id)
    end
end
